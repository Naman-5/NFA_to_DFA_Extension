class GetInputs {
  ...
  userInput() {
    ...
    this.single_response_questions(
    ...
    this.single_response_questions(
      "Enter the names for all the states (seperated by ,) :",
      "text",
      inputSection,
      "allStates",
      ""
    ...
    this.single_response_questions(
      "Enter the names of the initial state (seperated by ,) :",
      "text",
      inputSection,
      "initialStates",
      ""
    ...
    this.single_response_questions(
      "Enter the names of the final state (sperated by ,) :",
      "text",
      inputSection,
      "finalStates",
      ""
    ...
    this.single_response_questions(
      "Enter the input symbols (seperated by ,) :",
      "text",
      inputSection,
      "inputSymbols",
      ""
